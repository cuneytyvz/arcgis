...
define([
        ...
        'dojo/query',
        'dijit/registry',
        './GroupableLayerListView',
        './NlsStrings',
        'jimu/LayerInfos/LayerInfos'
    ],
    function (BaseWidget, declare, lang, array, html, request, dom, on, query, registry, GroupableLayerListView, NlsStrings, LayerInfos) {
        ...
        var clazz = declare([BaseWidget], {
            ...
            //groupableLayerListView: Object{}
            //  A module is responsible for show layers list
            groupableLayerListView: null,
            ...
            mergeGroupInfo: function () {
                var layerInfosObj = this.operLayerInfos;

                array.forEach(layerInfosObj.getLayerInfoArray(), lang.hitch(this, function (l) {
                    var exists = false;
                    array.forEach(this.groupInfo.groups, lang.hitch(this, function (group) {
                        for (var i = 0; i < group.layers.length; i++) {
                            if (group.layers[i].id == l.id)
                                group.layers[i] = l;
                        }
                    }));
                }));
            ...
            showLayers: function () {
                // summary:
                //    create a GroupableLayerListView module used to draw layers list in browser.
                this.groupableLayerListView = new GroupableLayerListView({
            ...
            _clearLayers: function () {
                ...
                if (this.groupableLayerListView && this.groupableLayerListView.destroyRecursive) {
                    this.groupableLayerListView.destroyRecursive();
                }
            },
            ...
            _onLayerInfosChanged: function (/*layerInfo, changedType*/) {
                this.groupableLayerListView.refresh();
            },
            ...
            _onLayerInfosRendererChanged: function (changedLayerInfos) {
                try {
                    array.forEach(changedLayerInfos, function (layerInfo) {
                        this.groupableLayerListView.redrawLegends(layerInfo);
                    }, this);
                } catch (err) {
                    this._refresh();
                }
